...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect(url_for('/tut_8/view.php?id=' . urlencode($task_id)));
}
...
<main>
    <div class="container">
        <a class="back-link" href="<?php echo url_for('/tut_8/view.php?id=' . urlencode($task_id)); ?>">&laquo; Back to List</a>
        <br/>
        <br/>
        <p>Add subtask</p>
        <br/>

        <form action="<?php echo url_for('/tut_8/subtask/add.php?task_id=' . urlencode($task_id)); ?>" method="post">
            <dl>
                <dt>Title:</dt>
